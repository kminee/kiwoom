...
class Red_Brain(QMainWindow, QWidget, form_class):       # QMainWindow, PyQt5에서 윈도우 생성시 필요한 함수정의
    ...
    def __init__(self, *args, **kwargs):                      # Main class의 self를 초기화 하고 시작
        ...
        ##git에서 txt 가지고오기
        self.selected_url = "https://raw.githubusercontent.com/kminee/kiwoom/refs/heads/main/selected.txt"
        ...
        ##### 이벤트 생성 및 진행
        ### 이벤트 1. 계좌정보 가지고오기
        self.call_account.clicked.connect(self.r_acc)         # 계좌정보가져
